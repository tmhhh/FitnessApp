...
class ImageBlot extends BlockEmbed {
  static create(value) {
    ...
    // imgTag.classList.add("ql-align-center");
    return imgTag;
  }
...
class QuillEditor extends React.Component {
  ...
  insertImage = (e) => {
    ...
    if (
      ...
      axios
        .post(`${API}/api/post/uploadfiles`, formData, config)
        .then((response) => {
    ...
    return (
      <>
        <div id="toolbar">
          ...
          <button className="ql-insertVideo">📼</button>
          {/* <button className="ql-insertFile">📂</button> */}
