...
import {Card, Col, Collapse, Divider, Row, Statistic, Tooltip} from "antd";
import {
        ...
        body = (
            <>
                        ...
                        <Col span={6}>
                            ...
                            >
                                <Statistic
                                    ...
                                    valueStyle={{color: caloriesRemaining > 0 ? '#02bb02' : '#cf1322'}}
                                    suffix={caloriesRemaining > 0 ? <i className="far fa-arrow-alt-circle-up"></i> :
                ...
                <Collapse defaultActiveKey={['1']}
                          bordered={false}
                          ghost
                          expandIcon={({isActive}) => <div style={{fontSize: 20}}>{!isActive ?
                              <i className="fas fa-chevron-circle-right"></i> :
                              <i className="fas fa-chevron-circle-down"></i>}</div>}>
                    <Panel header={<h1>Daily Menu <i className="fas fa-utensils"></i></h1>} key="1">

                        {!todayListFoods?.listFoods?.length ? (
                            <div className="d-flex flex-column align-items-center w-100 mt-5" style={{opacity: 0.2}}>
                                <i className="fas fa-utensils mb-3" style={{fontSize: 50}}></i>
                                <h1>No dishes added to today menu</h1>
                            </div>
                        ) : (
                            <Collapse defaultActiveKey={['1']} ghost>
                                <Panel header="Breakfast 🍞" key="1">
                                    {todayListFoods?.listFoods?.find((item) => item.mealType === 0) ? todayListFoods?.listFoods
                                        ...
                                        .map((e) => (
                                            ...
                                            >
                                                <div
                                                    className="tracking_meal_close_button d-flex justify-content-between align-items-center">
                                                    <i
                    ...
                    /> */}
                                        ...
                                        <div className="d-flex flex-column align-items-center w-100" style={{opacity: 0.2}}>
                                            <i className="fas fa-utensils" style={{fontSize: 24}}></i>
                                            <h4>No dishes</h4>
                                        </div>
                                    )}
                                </Panel>
                                <Panel header="Lunch 🍱" key="2">
                                    {todayListFoods?.listFoods?.find((item) => item.mealType === 1) ? todayListFoods?.listFoods
                    ...
                    /> */}
                                ...
                                <Panel header="Snacks 🍟" key="3">
                                    {todayListFoods?.listFoods?.find((item) => item.mealType === 2) ? todayListFoods?.listFoods
                    ...
                    /> */}
                                ...
                                <Panel header="Dinner 🍜" key="4">
                                    {todayListFoods?.listFoods?.find((item) => item.mealType === 3) ? todayListFoods?.listFoods
