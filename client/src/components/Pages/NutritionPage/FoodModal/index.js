            ...
            <Modal.Title>
              <div className="d-flex">
                <Image
                  width={70}
                  src={entity.image}
                  fallback={BASE_IMAGE_BASE_URL + "/dishes-default.png"}
                />
                <div className="ms-3">
            ...
            <Dropdown>
              ...
              >
                <Dropdown.Item value={0}>
                  <i className="fas fa-bread-slice"></i> Breakfast
                </Dropdown.Item>
                <Dropdown.Item value={1}>
                  <i className="fas fa-drumstick-bite"></i> Lunch
                </Dropdown.Item>
                <Dropdown.Item value={2}>
                  <i className="fas fa-pizza-slice"></i> Snacks
                </Dropdown.Item>
